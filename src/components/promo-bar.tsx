...
const STORAGE_KEY = "claimscribe-promo-dismissed";
...
export function PromoBar() {
  ...
  return (
    <div
      ...
      className="relative bg-blue-600 text-white text-sm text-center py-2.5 px-10"
    >
      <p className="font-medium">
        📸 AI-powered scoping: photos + voice → professional claims in minutes.{" "}
        <a

...
export function TableOfContents() {
  ...
  return (
    <nav
      ...
      style={{ borderColor: "#eff6ff", backgroundColor: "#eff6ff" + "33" }}
    ...
    >
      ...
      >
        <span className="text-sm font-semibold uppercase tracking-wider" style={{ color: "#2563eb" }}>
          📑 In This Article
        </span>
        <svg
          ...
          {items.map((item, index) => (
            <li key={item.id} className="flex items-start gap-2">
              <span
                ...
                style={{
                  backgroundColor: activeId === item.id ? "#2563eb" : "#eff6ff",
                  color: activeId === item.id ? "#fff" : "#1d4ed8",
                }}
              >
                {index + 1}
              </span>

...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/migrate-from`, lastModified: now, changeFrequency: "monthly" as const, priority: 0.8 },
    { url: `${base}/migrate-from/xactimate`, lastModified: now, changeFrequency: "monthly" as const, priority: 0.8 },
    { url: `${base}/migrate-from/encircle`, lastModified: now, changeFrequency: "monthly" as const, priority: 0.8 },
    { url: `${base}/migrate-from/manual-scoping`, lastModified: now, changeFrequency: "monthly" as const, priority: 0.8 },

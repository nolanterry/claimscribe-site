...
export const metadata: Metadata = {
  title: "System Status",
  description:
    "ClaimScribe system status — real-time operational status for all AI-powered damage scoping services. Check uptime, incidents, and scheduled maintenance.",
  alternates: { canonical: "/status" },
  openGraph: {
    title: "System Status | ClaimScribe",
    description:
      "ClaimScribe system status — real-time operational status for all AI-powered damage scoping services.",
    url: "https://claimscribe.ai/status",
  },
};
...
const SERVICES: Service[] = [
    { name: "AI Damage Analysis Engine", status: "operational" as const },
    { name: "Photo Documentation & Upload", status: "operational" as const },
    { name: "Xactimate Code Mapping", status: "operational" as const },
    { name: "PDF Report Generation", status: "operational" as const },
    { name: "Scope Builder", status: "operational" as const },
    { name: "API & Integrations", status: "operational" as const },
    { name: "Notification Service (Email)", status: "operational" as const },
        ...
        <div className="max-w-3xl mx-auto px-4 py-12 space-y-10">
          ...
          <section className="text-center pt-4">
            <p className="text-xs text-gray-400">
              ClaimScribe is hosted on Vercel&apos;s global edge network with automatic failover.
              <br />
              For real-time alerts, email{" "}
              <a href="mailto:support@claimscribe.ai" className="text-violet-600 hover:underline">
